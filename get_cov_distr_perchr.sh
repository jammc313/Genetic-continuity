...
#declare -a ind_1=( UstIshim Kotias sf12 Neanderthal flo011 )
declare -a ind_1=( LBK Loschbour Bichon SIII )
...
exit 0") | sbatch -p core -n 1 -t 1-00:00:00 -A p2018003 -J ${chr}_${ind_1[i]} -e DIR_error/${chr}_${ind_1[i]}.error
    done
done
